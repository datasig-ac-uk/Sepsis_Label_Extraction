...
if __name__ == '__main__':
    ...
    for definition in definitions:
        ...
        df_coxph = Coxph_df(df, features, original_features, a1, labels)
        ray.init(num_cpus=5)
        data = pin_in_object_store([df_coxph,  tra_full_indices, val_full_indices, k])
        analysis = tune.run(partial(model_cv,data_list=data,a1=a1),
        ...
        save_pickle(best_trial.config, Data_Dir +'hyperparameter/' + 'config' + definition[1:])