...
if __name__ == '__main__':
    ...
    print('Now 95% CI:')
    fprs_lists, tprs_lists=plot_functions_clean.fprs_tprs_output(labels_list_list,probs_list_list,n_bootstraps=n_bootstraps)
    ...
    fprs_lists_par,tprs_lists_par,labels_list_par,probs_list_par=plot_functions_clean.fprs_tprs_output_patient_level(labels_list_list,\
                                                                                                probs_list_list,\
                                                                                                test_indices_list_list)
    ...
    plot_functions_clean.auc_subplots(labels_list_par,probs_list_par,error_list_par,names,mean_fpr_list=mean_fpr_list,\
