...
if __name__ == '__main__':
    ...
    for model in constants.models:
        ...
        probs_list = []
        indices_list = []
        _, _, _, Output_predictions, _ = mimic3_myfunc.folders(
...
######################################  To produce AUC FIgures of LSTM/COXPHM ###################################
    purpose = 'test'
    plot_functions.auc_plots(definition_list=constants.FEATURES, model_list=constants.MODELS,
                             save_dir=constants.OUTPUT_DIR + 'plots/', T=6, train_test=purpose)
