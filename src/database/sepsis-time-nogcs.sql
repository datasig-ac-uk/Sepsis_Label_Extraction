/* 
This is a variation on the main script to extract sepsis time, sepsis-time-blood.sql. Here we use the pivoted_sofa_nogcs view
...
*/
  ...
  DROP MATERIALIZED VIEW IF EXISTS sepsis_cohort_time_blood_nogcs_2412 CASCADE;
CREATE MATERIALIZED VIEW sepsis_cohort_time_blood_nogcs_2412 AS
  ...
  WITH serv AS
       ...
       (
        SELECT --psofa.*, t_suspicion
          ...
          FROM unique_times u
          LEFT JOIN pivoted_sofa_nogcs psofa
