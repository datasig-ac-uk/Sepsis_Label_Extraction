/* 
This is a modified version of the one in mimic-lcp repo as we want to forward fill based on 
the last information we have. We create these other tables to find the last value of 
creatinine, bilirubin and platelets.
There are benefits and limitations to either approach. We have chosen this as this view is 
used to get pivoted sofa scores and forward filling will produce fewer fluctuations in the 
SOFA score. The downside may be that older data is not always an accurate representation

We use the same assignment of icustay ids as we used in extracted_labs

I have left some comments written by Alistair and also commented a few additional lines out with 
justification. Note the blood gases were already commented out in the original version in mimic-lcp.
        ...
        SELECT subject_id, charttime
          ...
          -- this also fuses together multiple ITEMIDs containing the same data
               ...
               , CASE
                      ...
                      WHEN itemid = 50868 AND valuenum <  0    THEN NULL -- this can be negative in extreme cases,
                                                                -- though that may also be caused by 
                                                               -- https://www.ajkd.org/article/S0272-6386(15)01055-0/pdf, 
                                                               -- though all negative values here seemed anomalous
         ...
         WHERE ITEMID IN
            ...
            -- I got rid of the above line compared with mimic-lcp as we are keeping cases 
            -- where the valuenum is null but the value may give us information as a text entry
        )
       , le_avg AS
        (
